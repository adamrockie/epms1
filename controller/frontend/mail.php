...
$mail->setFrom('info@appline.com.ng', 'Appline Solutions');
$mail->addAddress('ilamidi1st@yahoo.com', 'Lamidi Ismaila');     // Add a recipient
//$mail->addAddress('ellen@example.com');               // Name is optional
$mail->addReplyTo('info@appline.com.ng', 'Support');
